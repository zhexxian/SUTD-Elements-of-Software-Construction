...
public class VoteCastingWithNoDeadlock1 {
    ...
    // voter#1 (self)'s turn
        ...
        ServerSocket serverSocket = new ServerSocket(22221);
        ...
        out1.println("Voter #1 voted for " + vote);
        out1.flush();
        out2.println("Voter #1 voted for " + vote);
        out2.flush();
        out3.println("Voter #1 voted for " + vote);
        out3.flush();
        out4.println("Voter #1 voted for " + vote);
        out4.flush();
    ...
    // voter#4's turn, join voter#4's server
        ...
        in = new BufferedReader(
                    new InputStreamReader(echoSocket.getInputStream()));
        String fromVoter4 = in.readLine();
        System.out.println(fromVoter4); 
        votes[3] = fromVoter4.substring(19);
        echoSocket.close();
        in.close();
