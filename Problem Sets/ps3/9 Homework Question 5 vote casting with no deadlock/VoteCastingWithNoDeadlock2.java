...
public class VoteCastingWithNoDeadlock2 {
    ...
    // voter#2 (self)'s turn
        ...
        out1.println("Voter #2 voted for " + vote);
        out1.flush();
        out2.println("Voter #2 voted for " + vote);
        out2.flush();
        out3.println("Voter #2 voted for " + vote);
        out3.flush();
        out4.println("Voter #2 voted for " + vote);
        out4.flush();
