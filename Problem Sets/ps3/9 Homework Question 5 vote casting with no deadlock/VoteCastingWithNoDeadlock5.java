...
public class VoteCastingWithNoDeadlock5 {
    ...
    // voter#5 (self)'s turn
        ...
        out1.println("Voter #5 voted for " + vote);
        out1.flush();
        out2.println("Voter #5 voted for " + vote);
        out2.flush();
        out3.println("Voter #5 voted for " + vote);
        out3.flush();
        out4.println("Voter #5 voted for " + vote);
        out4.flush();
