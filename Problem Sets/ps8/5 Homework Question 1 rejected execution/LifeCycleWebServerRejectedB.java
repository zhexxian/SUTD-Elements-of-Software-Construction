...
public class LifeCycleWebServerRejectedB {
	// Exception case: (B) when the task queue is full 
	// ie when the limit of local 'memory' is reached
	// (changing executor pool size to 5)
	private static final ExecutorService exec = new ScheduledThreadPoolExecutor (5);
	
    public static void main(String[] args) throws Exception {
		ServerSocket socket = new ServerSocket(43210);
